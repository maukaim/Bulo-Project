...
public class FlowDtoAdapterImpl implements FlowDtoAdapter {
    ...
    public FlowDtoAdapterImpl(FlowStageDtoAdapter flowStageDtoAdapter,
    ...
    public FlowDto adapte(Flow flow) {
        return new FlowDto(
                ...
                resolveFailureAlternatives(flow.getFailureAlternativeRoutes()));
    }

    private Set<FailureAlternativeRoutesDto> resolveFailureAlternatives(Set<FailureAlternativeRoute> failureAlternativeRoutes) {
