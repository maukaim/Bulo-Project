...
public class OrchestrableContextView<ID> {
    ...
    private final Map<ContextStageId, List<TechnicalStageRun>> stageRunsByStageId;
    private final Instant startTime;
    private final Instant endTime;

    public OrchestrableContextView(ID runId, String flowId, OrchestrableContextStatus status, Map<ContextStageId, List<TechnicalStageRun>> stageRunsByStageId, Instant startTime, Instant endTime) {
        this.runId = runId;
        this.flowId = flowId;
        this.status = status;
    ...
    public Map<ContextStageId, List<TechnicalStageRun>> getStageRunsByStageId() {
