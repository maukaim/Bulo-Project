package com.maukaim.boule.trigger.swagger;

import com.maukaim.boule.trigger.swagger.config.DocketCustomizer;
import com.maukaim.boule.trigger.swagger.config.MaukaimSwaggerProperties;
import com.maukaim.boule.trigger.swagger.config.SwaggerConfigCustomizer;
import com.maukaim.boule.trigger.swagger.config.springfox.SpringfoxConfigurationProperties;
import com.maukaim.boule.trigger.swagger.config.springfox.SwaggerUiWebFluxConfiguration;
import com.maukaim.boule.trigger.swagger.config.springfox.SwaggerUiWebMvcConfiguration;
