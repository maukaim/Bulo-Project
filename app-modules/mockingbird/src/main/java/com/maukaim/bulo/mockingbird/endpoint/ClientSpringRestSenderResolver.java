...
public class ClientSpringRestSenderResolver extends AbstractSpringRestSenderResolver<ClientEventType> {

    public ClientSpringRestSenderResolver(SystemContext systemContext,
