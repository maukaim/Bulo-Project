...
## Which problems Bulo does solve?  
...
In theory, communication is seamlessly performed at the management team level so duplicates are spotted and the workforce is used efficiently, no waste. In practice, Management role includes a bunch of responsibilities, which makes difficult if not impossible for executives to spend enough time on spotting inefficiencies.
