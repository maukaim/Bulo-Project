...
public class FakeProvider {
    ...
    public static final StageDefinition STAGE_DEF_1 = new StageDefinition(
            "DEF_1",
            Map.of(),
    ...
    public static final StageDefinition STAGE_DEF_2 = new StageDefinition(
            "DEF_2",
    ...
    public static final TechnicalStage STAGE_1 = new TechnicalStage(
            "STAGE_1",
            List.of(new Parameter("Bobby","Name")),
            "DEF_1"
    );

    public static final TechnicalStage STAGE_2 = new TechnicalStage(
            "STAGE_2",
