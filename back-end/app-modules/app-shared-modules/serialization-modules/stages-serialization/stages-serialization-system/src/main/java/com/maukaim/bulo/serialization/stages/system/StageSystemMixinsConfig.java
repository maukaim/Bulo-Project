...
public class StageSystemMixinsConfig {
    ...
    public static final Map<Class<?>, Class<?>> STAGES_EVENT_SERVICE_JACKSON_MIXIN = Map.of(
            StageUpdateEvent.class, StageUpdateEventMixIn.class
    );

    public static final Map<Class<?>, Class<?>> STAGES_SERVICE_JACKSON_MIXIN = new HashMap<>() {{
